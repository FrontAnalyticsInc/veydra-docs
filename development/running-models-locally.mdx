...
<Tip>
  You can find your model's GitHub repository URL in the model's **Settings** page on [app.veydra.io](https://app.veydra.io). For more details on how models connect to GitHub, see [GitHub Integration](/features/github-integration).
</Tip>
