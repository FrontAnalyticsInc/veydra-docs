...
- **Flow Elements**: Blue circular flow nodes with a bowtie valve marker and stem for quick rate identification
- **Physical Connections**: Blue pipe-style links with directional arrowheads for transfers
- **Causal Connectors**: Gray dashed links for influence relationships
- **Parameter-Like Elements**: Smaller green circular nodes for parameter, constant, converter, and variable terms, with auxiliary shown as orange circles
...
<Note>
  The diagram and the code may have a slight delay before updates reflect changes made
</Note>
