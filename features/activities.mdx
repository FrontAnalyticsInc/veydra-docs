...
<Info>
  **New to Veydra?** Start with the [Model Playground](/features/model-playground) — Veydra's central workspace where you build, modify, and test your system dynamics models with real-time feedback and powerful visualization tools.
</Info>
